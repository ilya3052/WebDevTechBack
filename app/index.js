...
const fields = [
    ...
    { id: "house", errorClass: "house_error", validate: (v) => v === "" || v <= 0, msg: "Укажите корректный номер дома" },
    ...
    { id: "floor", errorClass: "floor_error", validate: (v) => (v.length > 0 && v < 0) || hasLetter(v), msg: "Укажите корректный номер этажа" },
